...
var ServerPlatformLocation = class _ServerPlatformLocation {
  ...
  constructor() {
    ...
    if (config.url) {
      const {
        ...
        hash,
        href
      } = resolveUrl(config.url, this._doc.location.origin);
  ...
  replaceState(state, title, newUrl) {
    ...
    const {
      ...
      href,
      protocol
    } = resolveUrl(newUrl, this._doc.location.origin);
...
//# sourceMappingURL=chunk-RVMMMPWB.js.map
